...
class Peon(BaseModel):
    user = models.OneToOneField("users.CustomUser", on_delete=models.CASCADE)
    school = models.ManyToManyField("school.School")


class Accountant(BaseModel):
    user = models.OneToOneField("users.CustomUser", on_delete=models.CASCADE)
    school = models.ForeignKey(
        "school.School", on_delete=models.CASCADE, related_name="school_accountant"
    )
...
class Receptionist(BaseModel):
    ...
    school = models.OneToOneField(
        "school.School", on_delete=models.CASCADE, related_name="school_receptionist"
    )
...
def create_user_profile(sender, instance, created, **kwargs):
    if created:
        ...
        elif instance.role == CustomUser.PEON:
            Peon.objects.create(user=instance)
        elif instance.role == CustomUser.ACCOUNTANT:
